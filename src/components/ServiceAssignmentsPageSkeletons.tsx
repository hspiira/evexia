...
export function ServiceAssignmentsListSkeleton() {
  return (
    <div className="space-y-3">
      <div className="grid grid-cols-[1.4fr_1.4fr_0.8fr_0.8fr_0.8fr] gap-3 border-b border-fg/10 bg-surface px-3 py-2">
...
export function ServiceAssignmentDetailSkeleton() {
  return (
    <div className="space-y-5">
      <div className="border border-fg/10 bg-surface">
        <div className="flex items-center gap-3 border-b border-fg/10 px-5 py-3">
          ...
          <Skeleton className={cn(skeletonClass, "h-4 w-40")} />
          <Skeleton className={cn(skeletonClass, "h-5 w-16")} />
        </div>
      </div>
      <div className="grid grid-cols-12 gap-5 px-5">
        <div className="col-span-12 lg:col-span-8 space-y-3">
          <Skeleton className={cn(skeletonClass, "h-9 w-64")} />
