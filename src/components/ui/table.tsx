...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn("border-b border-ink/30 bg-white rounded-none", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-ink/20 transition-colors hover:bg-surface-tile data-[state=selected]:bg-selection rounded-none",
      className
    )}
    {...props}
  />
