...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn("border-b border-[#5A626A]/30 bg-white rounded-none", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-[#5A626A]/20 transition-colors hover:bg-[#f0f0f0] data-[state=selected]:bg-selection rounded-none",
      className
    )}
    {...props}
  />
