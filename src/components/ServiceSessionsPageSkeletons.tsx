...
export function ServiceSessionsListSkeleton() {
  return (
    <div className="space-y-3">
      <div className="grid grid-cols-[1.4fr_1.4fr_1.4fr_0.8fr_0.8fr] gap-3 border-b border-fg/10 bg-surface px-3 py-2">
...
export function ServiceSessionDetailSkeleton() {
  return (
