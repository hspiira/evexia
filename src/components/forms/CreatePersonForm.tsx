    ...
    <form onSubmit={handleSubmit} className="space-y-2">
      ...
      {formData.person_type === 'ClientEmployee' && (
        <FormAccordionSection title="Employment (optional)">
          <p className="text-xs text-safe-light -mt-1">Employee code will be auto-generated by the system.</p>
          <div className="grid grid-cols-2 gap-2">
      ...
      <div className="flex gap-2 pt-2">
        ...
        {onCancel != null && (
          <button type="button" onClick={onCancel} disabled={loading} className="px-4 py-2 bg-safe hover:bg-safe-dark text-white rounded-none transition-colors">Cancel</button>
        )}
      </div>
    </form>
  )
