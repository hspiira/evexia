      ...
      <div>
        ...
        <div className="flex gap-2 items-center">
          <input
            ...
            className="w-10 h-10 rounded-none border border-[0.5px] border-safe/30 cursor-pointer bg-white"
          />
          <input
            type="text"
            ...
            className="flex-1 px-4 py-2 bg-white border border-[0.5px] border-safe/30 rounded-none focus:outline-none focus:border-natural text-safe"
          />
        </div>
      </div>
      <FormField
