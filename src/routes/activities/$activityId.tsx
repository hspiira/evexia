  ...
  return (
    <AppLayout>
      <div className="max-w-7xl mx-auto">
        ...
        {editing ? (
          <div className="bg-calm border border-[0.5px] border-safe p-6 max-w-2xl">
            ...
            <div className="space-y-4">
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  className="w-full px-4 py-2 bg-calm border border-[0.5px] border-safe rounded-none focus:outline-none focus:border-natural"
                />
              </div>
              <FormField
                label="Description"
