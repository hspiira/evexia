 ...
 * Industry tree with search, filters, and create modal
 */
...
export function IndustriesTab() {
  ...
  return (
    <div className="space-y-0">
      <h2 className="text-sm font-semibold text-safe mb-1.5">Industries</h2>
      <p className="text-xs text-safe-light mb-2">Industry classifications for clients.</p>
      <TableFilters
