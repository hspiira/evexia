    ...
    <div className="content-area-scroll flex-1 min-h-0 overflow-y-auto p-6">
      <div className="mx-auto max-w-5xl space-y-4">
        <header className="flex items-center justify-between">
          <div>
            <h1 className="text-xl font-semibold text-fg">Care callback campaigns</h1>
        ...
        <nav className="flex gap-3 text-sm text-fg/70">
          <Link
        ...
        {query.isPending ? (
          ...
          <p className="text-sm text-fg/60">No campaigns yet. Create one to start a wave.</p>
        ) : (
                ...
                <li key={c.id} className="p-4">
                  <div className="flex items-start justify-between gap-4">
                    <div className="min-w-0 flex-1">
                      ...
                      {c.description ? (
                        <p className="mt-1 text-sm text-fg/70 line-clamp-2">{c.description}</p>
                      ) : null}
